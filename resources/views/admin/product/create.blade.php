                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" id="thumb_image" name="thumb_image" class="dropify" data-max-file-size="1M" data-allowed-file-extensions="png jpg jpeg" accept="image/png, image/jpeg">
                                <span class="help-block"><small>* ukuran gambar maksimal 1024 KB (1 MB)</small></span>
                            </div>
                            <div class="mb-3">
                                <label for="name" class="form-label">Nama Produk *</label>
                                <input type="text" id="name" name="name" class="form-control" placeholder="Nama Produk" maxlength="255" value="{{ old('name') }}" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" id="price" name="price" class="form-control" placeholder="Harga" min="1" value="{{ old('price') }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="offer_price" class="form-label">Harga (Diskon)</label>
                                        <input type="number" id="offer_price" name="offer_price" class="form-control" placeholder="Harga (Diskon)" min="1" value="{{ old('offer_price') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="short_description" class="form-label">Deskripsi Singkat *</label>
                                <textarea id="short_description" name="short_description" class="form-control" placeholder="Deskripsi Singkat" rows="3" required>{{ old('short_description') }}</textarea>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="sku" name="sku" class="form-control" placeholder="SKU" maxlength="255" value="{{ old('sku') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="seo_title" class="form-label">Judul (SEO)</label>
                                        <input type="text" id="seo_title" name="seo_title" class="form-control" placeholder="Judul (SEO)" maxlength="255" value="{{ old('seo_title') }}">
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label for="seo_description" class="form-label">Deskripsi (SEO)</label>
                                    <input type="text" id="seo_description" name="seo_description" class="form-control" placeholder="Deskripsi (SEO)" maxlength="255" value="{{ old('seo_description') }}">
                                </div>
                            </div>
