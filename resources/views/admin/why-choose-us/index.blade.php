                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="title" name="title" class="form-control" placeholder="Judul" maxlength="255">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="sub_title" class="form-label">Sub Judul</label>
                                                    <input type="text" id="sub_title" name="sub_title" class="form-control" placeholder="Sub Judul" maxlength="255">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-3">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h4>Teks "Mengapa Memilih Kita"</h4>
                        <a href="{{ route('admin.slider.create') }}" class="btn btn-primary">Tambah Teks "Mengapa Memilih
                            Kita"</a>
                    </div>
                    <div class="card-body">
