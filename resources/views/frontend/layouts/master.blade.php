...
<head>
    ...
    <title>@yield('title') || Restaurant Template</title>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/libs/toastr/build/toastr.min.css') }}">
...
<body>
    ...
    <!-- toastr js -->
    <script src="{{ asset('frontend/libs/toastr/build/toastr.min.js') }}"></script>
